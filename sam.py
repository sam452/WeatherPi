...
def completeCommand():
        ...
        f = open("/home/pi/apps/WeatherPi/WeatherPiSolarPoweredWeather/state/WeatherCommand.txt", "w")
        f.write("DONE")
        f.close()
...
def processCommand():
        ...
        f = open("//home/pi/apps/WeatherPi/WeatherPiSolarPoweredWeather/state/WeatherCommand.txt", "r")
        command = f.read()
        f.close()
...
def writeWeatherStats():
        ...
        f = open("/home/pi/apps/WeatherPi/WeatherPiSolarPoweredWeather/state/WeatherStats.txt", "w")
...
def WLAN_check():
	...
	global WLAN_check_flg
        ping_ret = subprocess.call(['ping -c 2 -w 1 -q 192.168.1.10 |grep "1 received" > /dev/null 2> /dev/null'], shell=True)
	if ping_ret:
